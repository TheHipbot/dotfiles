...
sudo scutil --set ComputerName "HIPBAWT"
sudo scutil --set HostName "HIPBAWT"
sudo scutil --set LocalHostName "HIPBAWT"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "HIPBAWT"
...
# Set menu bar to use dark theme
